...
{foreach from=$cart.wallet_system item="gift" key="gift_key" name="f_gift_certificates"}
{assign var="obj_id" value=$gift.object_id|default:$gift_key}
{if !$smarty.capture.prods}
    {capture name="prods"}Y{/capture}
{/if}
<tr>   
       <td><img src="design/backend/media/images/addons/wallet_system/Wallet-Icon.png" width="50" height="50"></td>
