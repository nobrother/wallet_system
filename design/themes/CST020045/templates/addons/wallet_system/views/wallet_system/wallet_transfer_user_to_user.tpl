...
<center><span><img src="design/backend/media/images/addons/wallet_system/Wallet-Icon.png" width="23" /></span>&nbsp;&nbsp;
<strong style="font-size:20px;">{__("total_amount")}&nbsp;&nbsp;{include file="common/price.tpl" value=$total_cash}</strong></center>
	<form action="{"wallet_system.create_transfer"|fn_url}" method="post" name="my_wallet_create_transfer">
	    ...
	    <br>
	    <label class="cm-required ty-control-group__title" for="this_wallet_enter_amount">{__("enter_amount")}({$primary_currency})</label>
